---
name: code-review
description: "Structured pull request review using specialized agents — security, bugs, quality, contracts, test coverage, historical context."
autoload: false
version: 1.0.0
author: neolabhq
...
mcp_schema:
  inputs:
    pr_url:
      ...
      maxLength: 500
      required: true
      description: "URL or identifier of the pull request to review"
    review_aspects:
      type: string
      maxLength: 500
      required: false
      description: "Comma-separated focus areas (security, performance, etc.)"
    min_impact:
      type: string
      maxLength: 20
      required: false
      description: "Minimum impact level to report (critical, high, medium, medium-low, low)"
  outputs:
    issues_found:
      type: string
      maxLength: 8000
      description: "List of issues with confidence and impact scores"
    inline_comments:
      type: string
      maxLength: 10000
      description: "Formatted inline review comments for the PR"
---
