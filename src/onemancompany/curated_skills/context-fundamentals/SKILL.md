...
description: "Context engineering for AI agent systems — attention budgets, progressive disclosure, prompt organization, context window optimization."
autoload: false
version: 2.0.0
...
mcp_schema:
  inputs:
    scenario:
      ...
      maxLength: 2000
      required: true
      description: "Description of the context engineering scenario or problem"
    current_context_size:
      type: integer
      maximum: 2000000
      required: false
      description: "Approximate token count of current context"
    agent_type:
      type: string
      maxLength: 100
      required: false
      description: "Type of agent system (single-agent, multi-agent, hierarchical)"
  outputs:
    recommendations:
      type: string
      maxLength: 5000
      description: "Context optimization recommendations with rationale"
    budget_allocation:
      type: string
      maxLength: 3000
      description: "Suggested token budget allocation across context components"
---
